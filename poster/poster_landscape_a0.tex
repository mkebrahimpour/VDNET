\documentclass[landscape,paperwidth=46.8in,paperheight=33.1in,fontscale=0.292]{baposter}
...
\begin{poster}{
 ...
 % Eye Catcher
 {
      \includegraphics[width=0.08\linewidth]{ucCAL.png}
      \makebox[0.01\textwidth]{} 
      \raisebox{0.08\height}{\includegraphics[width=0.1\linewidth]{ancestry.jpg}}
 ...
 {
    \begin{tabular}{r}
        \includegraphics[width=0.08\linewidth]{wacv.png}
    \end{tabular}
 }
...
%                                               Inspirations                                                            
% ========================================================
\headerbox{\bf\color{blue} Brain Inspirations}{name=inspiration,column=0,row=0,span=3}{
...
%========================================================
                                                 Literature Review
% ========================================================
\headerbox{\bf\color{blue} Literature Review}{name=LR,column=3,row=0,span=3}{
\begin{tabular}{cc}
...
% ------------------------------ Part 1 -----------------------------------------
\headerbox{\bf\color{blue} Experiments \& Results}{name=results,column=3,below=LR,span=3}{
...
% -------------------------------- Part 4 --------------------------------------
 ...
 \begin{minipage}[t]{0.33\textwidth}
    ...
    \begin{minipage}[t]{0.33\textwidth}
        ...
        \vspace{-0.8em}
        \begin{center}
            \includegraphics[width=0.8\textwidth]{images/sa}
        \end{center}
   \end{minipage}
       \begin{minipage}[t]{0.34\textwidth}
        \textbf{\color{blue} VDNet on Github:} 
       \vspace{-0.5em}
        \begin{center}
            \includegraphics[width=0.4\textwidth]{images/VDNet_QR.png}
       \end{center}
   \end{minipage}
}
%=========================================================
...
% ========================================================
\headerbox{\bf\color{blue} Dual Networks: Ventral and Dorsal}{name=formulation,column=0,below=inspiration,span=3}{
    \vspace{-0.5em}
    \begin{center}
...
%    \vspace{-0.5em}
 ...
 %   \vspace{-0.5em} 
\textbf{\color{blue}Gestalt Total (GT):}\\
...
\end{equation}
which $I$ denotes the current image.\\
